...
import { computePoolAddress, FeeAmount, Pool } from '@cytoswap/v3-sdk';
import retry, { Options as RetryOptions } from 'async-retry';
import _ from 'lodash';

import { ICytoswapV3PoolState__factory } from '../../types/v3/factories/ICytoswapV3PoolState__factory';
  ...
  private async getPoolsData<TReturn>(
    ...
    const { results, blockNumber } = await retry(async () => {
      ...
      >({
        ...
        contractInterface: ICytoswapV3PoolState__factory.createInterface(),
